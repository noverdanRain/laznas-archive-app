...
export default function TableHeader({ stickyTop = 164 }: { stickyTop?: number }) {
    ...
    return (
        <header className={`grid grid-cols-[5fr_3fr_2fr_2.5fr_0.9fr_0.6fr] gap-x-4 bg-white rounded-t-2xl border border-gray-200 text-sm sticky top-[${stickyTop}px] z-30 transition-all duration-300`}>
